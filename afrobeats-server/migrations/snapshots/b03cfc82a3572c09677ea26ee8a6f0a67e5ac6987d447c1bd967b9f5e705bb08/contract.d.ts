...
export type StorageHash =
  StorageHashBase<'b03cfc82a3572c09677ea26ee8a6f0a67e5ac6987d447c1bd967b9f5e705bb08'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly BeatAsset: {
      ...
      readonly type:
        'ARTWORK' | 'PREVIEW_MASTERED_TAGGED' | 'MP3_UNMASTERED' | 'WAV_UNMASTERED' | 'STEMS_ZIP';
    ...
    readonly LicenseType: {
      ...
      readonly terms: CodecTypes['pg/json@1']['output'];
      readonly active: CodecTypes['pg/bool@1']['output'];
    ...
    readonly Order: {
      ...
      readonly accessTokenHash: CodecTypes['pg/text@1']['output'] | null;
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly LicenseType: {
      ...
      readonly terms: CodecTypes['pg/json@1']['input'];
      readonly active: CodecTypes['pg/bool@1']['input'];
    ...
    readonly Order: {
      ...
      readonly accessTokenHash: CodecTypes['pg/text@1']['input'] | null;
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly downloadGrant: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [
                { readonly columns: readonly ['orderId', 'orderItemId', 'assetId'] },
              ];
              indexes: readonly [
                {
            ...
            readonly order: {
              ...
              uniques: readonly [
                ...
                { readonly columns: readonly ['accessTokenHash'] },
              ];
              indexes: readonly [
                {
      ...
      readonly public: {
          ...
          readonly Order: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly accessTokenHash: { readonly column: 'accessTokenHash' };
        ...
        readonly enum: {
          ...
          readonly AssetType: {
            readonly codecId: 'pg/text@1';
            readonly members: readonly [
              { readonly name: 'ARTWORK'; readonly value: 'ARTWORK' },
              {
